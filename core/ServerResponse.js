 ...
 */
response.addListener = response.ServerResponse.prototype.addListener = function (event, handler, ahead) {
 ...
 * @return {bool}
 */
response.ServerResponse.prototype.hasResponse = function () {
	return this._listener_e == 'header' ? false : true;
}