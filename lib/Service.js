...
exports.register = function (name, obj) {
  ...
  if (!allServices[name]) {
    ...
    Object.defineProperty(global.QuickWeb.Service, name, {
      get: function () {
        return exports.import(name);
      },
      set: function () {
        throw Error('Service "' + name + '" is read only!');
      }
    });
  }
  // 如果存在，则抛出异常
...
exports.import = function (name) {
  ...
  if (!allServices[name])
    ...
    return Object.freeze(allServices[name]);
}
...
exports.load = function (name) {
  ...
  try {
    ...
    throw Error('Cannot load service "' + name + '"! (' + filename + ')');
  }
}
